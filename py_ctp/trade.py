...
from py_ctp.enums import BizTypeType, ActionFlagType, ActionTypeType, BankAccTypeType, FuturePwdFlagType, SecuAccTypeType, ClientIDTypeType, ExecOrderCloseFlagType, CombDirectionType, ContingentConditionType, CustTypeType, DirectionType, FeePayFlagType, ForceCloseReasonType, HedgeFlagType, IdCardTypeType, LastFragmentType, LockTypeType, LoginModeType, OffsetFlagType, OrderPriceTypeType, ExecOrderPositionFlagType, PosiDirectionType, ProductClassType, TimeConditionType, OrderStatusType, TransferStatusType, UserTypeType, VolumeConditionType, CertificationTypeType
from py_ctp.structs import CThostFtdcAccountregisterField, CThostFtdcBatchOrderActionField, CThostFtdcBrokerTradingAlgosField, CThostFtdcBrokerTradingParamsField, CThostFtdcBulletinField, CThostFtdcCFMMCTradingAccountKeyField, CThostFtdcCFMMCTradingAccountTokenField, CThostFtdcCancelAccountField, CThostFtdcChangeAccountField, CThostFtdcCombActionField, CThostFtdcCombInstrumentGuardField, CThostFtdcContractBankField, CThostFtdcDepthMarketDataField, CThostFtdcETFOptionInstrCommRateField, CThostFtdcEWarrantOffsetField, CThostFtdcExchangeField, CThostFtdcExchangeMarginRateAdjustField, CThostFtdcExchangeMarginRateField, CThostFtdcExchangeRateField, CThostFtdcExecFreezeField, CThostFtdcExecOrderActionField, CThostFtdcExecOrderField, CThostFtdcFensUserInfoField, CThostFtdcForQuoteField, CThostFtdcForQuoteRspField, CThostFtdcInputBatchOrderActionField, CThostFtdcInputCombActionField, CThostFtdcInputExecOrderActionField, CThostFtdcInputExecOrderField, CThostFtdcInputForQuoteField, CThostFtdcInputLockField, CThostFtdcInputOrderActionField, CThostFtdcInputOrderField, CThostFtdcInputQuoteActionField, CThostFtdcInputQuoteField, CThostFtdcInstrumentCommissionRateField, CThostFtdcInstrumentField, CThostFtdcInstrumentMarginRateField, CThostFtdcInstrumentOrderCommRateField, CThostFtdcInstrumentStatusField, CThostFtdcInvestorField, CThostFtdcInvestorLevelField, CThostFtdcInvestorPositionCombineDetailField, CThostFtdcInvestorPositionDetailField, CThostFtdcInvestorPositionField, CThostFtdcInvestorProductGroupMarginField, CThostFtdcLockField, CThostFtdcLockPositionField, CThostFtdcMMInstrumentCommissionRateField, CThostFtdcMMOptionInstrCommRateField, CThostFtdcNoticeField, CThostFtdcNotifyQueryAccountField, CThostFtdcOpenAccountField, CThostFtdcOptionInstrCommRateField, CThostFtdcOptionInstrTradeCostField, CThostFtdcOrderActionField, CThostFtdcOrderField, CThostFtdcParkedOrderActionField, CThostFtdcParkedOrderField, CThostFtdcProductExchRateField, CThostFtdcProductField, CThostFtdcProductGroupField, CThostFtdcQryAccountregisterField, CThostFtdcQryBrokerTradingAlgosField, CThostFtdcQryBrokerTradingParamsField, CThostFtdcQryCFMMCTradingAccountKeyField, CThostFtdcQryCombActionField, CThostFtdcQryCombInstrumentGuardField, CThostFtdcQryContractBankField, CThostFtdcQryDepthMarketDataField, CThostFtdcQryETFOptionInstrCommRateField, CThostFtdcQryEWarrantOffsetField, CThostFtdcQryExchangeField, CThostFtdcQryExchangeMarginRateAdjustField, CThostFtdcQryExchangeMarginRateField, CThostFtdcQryExchangeRateField, CThostFtdcQryExecFreezeField, CThostFtdcQryExecOrderField, CThostFtdcQryForQuoteField, CThostFtdcQryInstrumentCommissionRateField, CThostFtdcQryInstrumentField, CThostFtdcQryInstrumentMarginRateField, CThostFtdcQryInstrumentOrderCommRateField, CThostFtdcQryInvestorField, CThostFtdcQryInvestorLevelField, CThostFtdcQryInvestorPositionCombineDetailField, CThostFtdcQryInvestorPositionDetailField, CThostFtdcQryInvestorPositionField, CThostFtdcQryInvestorProductGroupMarginField, CThostFtdcQryLockField, CThostFtdcQryLockPositionField, CThostFtdcQryMMInstrumentCommissionRateField, CThostFtdcQryMMOptionInstrCommRateField, CThostFtdcQryNoticeField, CThostFtdcQryOptionInstrCommRateField, CThostFtdcQryOptionInstrTradeCostField, CThostFtdcQryOrderField, CThostFtdcQryParkedOrderActionField, CThostFtdcQryParkedOrderField, CThostFtdcQryProductExchRateField, CThostFtdcQryProductField, CThostFtdcQryProductGroupField, CThostFtdcQryQuoteField, CThostFtdcQrySecAgentACIDMapField, CThostFtdcQrySettlementInfoConfirmField, CThostFtdcQrySettlementInfoField, CThostFtdcQryTradeField, CThostFtdcQryTradingAccountField, CThostFtdcQryTradingCodeField, CThostFtdcQryTradingNoticeField, CThostFtdcQryTransferBankField, CThostFtdcQryTransferSerialField, CThostFtdcQueryCFMMCTradingAccountTokenField, CThostFtdcQueryMaxOrderVolumeField, CThostFtdcQuoteActionField, CThostFtdcQuoteField, CThostFtdcRemoveParkedOrderActionField, CThostFtdcRemoveParkedOrderField, CThostFtdcReqAuthenticateField, CThostFtdcReqQueryAccountField, CThostFtdcReqRepealField, CThostFtdcReqTransferField, CThostFtdcReqUserLoginField, CThostFtdcRspAuthenticateField, CThostFtdcRspInfoField, CThostFtdcRspRepealField, CThostFtdcRspTransferField, CThostFtdcRspUserLoginField, CThostFtdcSecAgentACIDMapField, CThostFtdcSettlementInfoConfirmField, CThostFtdcSettlementInfoField, CThostFtdcTradeField, CThostFtdcTradingAccountField, CThostFtdcTradingAccountPasswordUpdateField, CThostFtdcTradingCodeField, CThostFtdcTradingNoticeField, CThostFtdcTradingNoticeInfoField, CThostFtdcTransferBankField, CThostFtdcTransferSerialField, CThostFtdcUserLogoutField, CThostFtdcUserPasswordUpdateField, CThostFtdcErrorConditionalOrderField
...
class Trade:
    ...
    def __OnRspQryInvestorPositionCombineDetail(self, pInvestorPositionCombineDetail, pRspInfo, nRequestID, bIsLast):
        self.OnRspQryInvestorPositionCombineDetail(
            POINTER(CThostFtdcInvestorPositionCombineDetailField).from_param(pInvestorPositionCombineDetail).contents.clone(), POINTER(CThostFtdcRspInfoField).from_param(pRspInfo).contents.clone(), nRequestID, bIsLast)
    ...
    def ReqParkedOrderInsert(self,
        ...
        struc.Status = list(OrderStatusType)[0].value if Status == '' else Status.value
    ...
    def ReqExecOrderInsert(self,
        ...
        struc.ReservePositionFlag = list(ExecOrderPositionFlagType)[0].value if ReservePositionFlag == '' else ReservePositionFlag.value
        struc.CloseFlag = list(ExecOrderCloseFlagType)[0].value if CloseFlag == '' else CloseFlag.value
        struc.ExchangeID = bytes(ExchangeID, encoding='ascii')
        struc.InvestUnitID = bytes(InvestUnitID, encoding='ascii')
        struc.AccountID = bytes(AccountID, encoding='ascii')
        struc.CurrencyID = bytes(CurrencyID, encoding='ascii')
    ...
    def ReqQuoteInsert(self,
        ...
        struc.RequestID = RequestID
        struc.BusinessUnit = bytes(BusinessUnit, encoding='ascii')
        struc.AskOffsetFlag = list(OffsetFlagType)[0].value if AskOffsetFlag == '' else AskOffsetFlag.value
        struc.BidOffsetFlag = list(OffsetFlagType)[0].value if BidOffsetFlag == '' else BidOffsetFlag.value
        struc.AskHedgeFlag = list(HedgeFlagType)[0].value if AskHedgeFlag == '' else AskHedgeFlag.value
        struc.BidHedgeFlag = list(HedgeFlagType)[0].value if BidHedgeFlag == '' else BidHedgeFlag.value
    ...
    def ReqLockInsert(self, BrokerID='', InvestorID='', InstrumentID='', LockRef='', UserID='', Volume=0, RequestID=0, BusinessUnit='', LockType='', ExchangeID='', IPAddress='', MacAddress=''):
        ...
        struc.RequestID = RequestID
        struc.BusinessUnit = bytes(BusinessUnit, encoding='ascii')
        struc.LockType = list(LockTypeType)[0].value if LockType == '' else LockType.value
        struc.ExchangeID = bytes(ExchangeID, encoding='ascii')
        struc.IPAddress = bytes(IPAddress, encoding='ascii')
        struc.MacAddress = bytes(MacAddress, encoding='ascii')
    ...
    def ReqQryTradingAccount(self, BrokerID='', InvestorID='', CurrencyID='', BizType=''):
        ...
        struc.InvestorID = bytes(InvestorID, encoding='ascii')
        struc.CurrencyID = bytes(CurrencyID, encoding='ascii')
        struc.BizType = list(BizTypeType)[0].value if BizType == '' else BizType.value
    ...
    def ReqFromBankToFutureByFuture(self,
        ...
        struc.UserID = bytes(UserID, encoding='ascii')
        struc.VerifyCertNoFlag = list(CertificationTypeType)[0].value if VerifyCertNoFlag == '' else VerifyCertNoFlag.value
        struc.CurrencyID = bytes(CurrencyID, encoding='ascii')
        ...
        struc.BankSecuAccType = list(SecuAccTypeType)[0].value if BankSecuAccType == '' else BankSecuAccType.value
        struc.BrokerIDByBank = bytes(BrokerIDByBank, encoding='ascii')
        struc.BankSecuAcc = bytes(BankSecuAcc, encoding='ascii')
        struc.BankPwdFlag = list(FuturePwdFlagType)[0].value if BankPwdFlag == '' else BankPwdFlag.value
        struc.SecuPwdFlag = list(FuturePwdFlagType)[0].value if SecuPwdFlag == '' else SecuPwdFlag.value
