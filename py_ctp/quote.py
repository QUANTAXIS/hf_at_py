...
from py_ctp.structs import CThostFtdcDepthMarketDataField, CThostFtdcFensUserInfoField, CThostFtdcForQuoteRspField, CThostFtdcReqUserLoginField, CThostFtdcRspInfoField, CThostFtdcRspUserLoginField, CThostFtdcSpecificInstrumentField, CThostFtdcUserLogoutField
...
class Quote:
    ...
    def RegCB(self):
        ...
        self.evOnFrontDisconnected = CFUNCTYPE(
            c_void_p, c_int32)(self.__OnFrontDisconnected)
        ...
        self.evOnHeartBeatWarning = CFUNCTYPE(
            c_void_p, c_int32)(self.__OnHeartBeatWarning)
        ...
        self.evOnRspUserLogin = CFUNCTYPE(c_void_p,
                                          POINTER(CThostFtdcRspUserLoginField),
                                          POINTER(CThostFtdcRspInfoField),
                                          c_int32,
                                          c_bool)(self.__OnRspUserLogin)
        ...
        self.evOnRspUserLogout = CFUNCTYPE(c_void_p,
                                           POINTER(CThostFtdcUserLogoutField),
                                           POINTER(CThostFtdcRspInfoField),
                                           c_int32,
                                           c_bool)(self.__OnRspUserLogout)
        ...
        self.evOnRspError = CFUNCTYPE(c_void_p,
                                      POINTER(CThostFtdcRspInfoField), c_int32,
                                      c_bool)(self.__OnRspError)
        ...
        self.evOnRspSubMarketData = CFUNCTYPE(
            c_void_p,
            POINTER(CThostFtdcSpecificInstrumentField),
            POINTER(CThostFtdcRspInfoField), c_int32,
            c_bool)(self.__OnRspSubMarketData)
        ...
        self.evOnRspUnSubMarketData = CFUNCTYPE(
            c_void_p,
            POINTER(CThostFtdcSpecificInstrumentField),
            POINTER(CThostFtdcRspInfoField), c_int32,
            c_bool)(self.__OnRspUnSubMarketData)
        ...
        self.evOnRspSubForQuoteRsp = CFUNCTYPE(
            c_void_p,
            POINTER(CThostFtdcSpecificInstrumentField),
            POINTER(CThostFtdcRspInfoField), c_int32,
            c_bool)(self.__OnRspSubForQuoteRsp)
        ...
        self.evOnRspUnSubForQuoteRsp = CFUNCTYPE(
            c_void_p,
            POINTER(CThostFtdcSpecificInstrumentField),
            POINTER(CThostFtdcRspInfoField), c_int32,
            c_bool)(self.__OnRspUnSubForQuoteRsp)
        ...
        self.evOnRtnDepthMarketData = CFUNCTYPE(
            c_void_p, POINTER(CThostFtdcDepthMarketDataField))(
                self.__OnRtnDepthMarketData)
        ...
        self.evOnRtnForQuoteRsp = CFUNCTYPE(
            c_void_p,
            POINTER(CThostFtdcForQuoteRspField))(self.__OnRtnForQuoteRsp)
    ...
    def __OnRspUserLogin(self, pRspUserLogin, pRspInfo, nRequestID, bIsLast):
        self.OnRspUserLogin(
            POINTER(CThostFtdcRspUserLoginField).from_param(
                pRspUserLogin).contents.clone(),
            POINTER(CThostFtdcRspInfoField).from_param(pRspInfo)
            .contents.clone(), nRequestID, bIsLast)

    def __OnRspUserLogout(self, pUserLogout, pRspInfo, nRequestID, bIsLast):
        self.OnRspUserLogout(
            POINTER(CThostFtdcUserLogoutField).from_param(
                pUserLogout).contents.clone(),
            POINTER(CThostFtdcRspInfoField).from_param(pRspInfo)
            .contents.clone(), nRequestID, bIsLast)
    ...
    def __OnRspSubMarketData(self, pSpecificInstrument, pRspInfo, nRequestID,
                             bIsLast):
        self.OnRspSubMarketData(
            POINTER(CThostFtdcSpecificInstrumentField).from_param(
                pSpecificInstrument).contents.clone(),
            POINTER(CThostFtdcRspInfoField).from_param(pRspInfo)
            .contents.clone(), nRequestID, bIsLast)

    def __OnRspUnSubMarketData(self, pSpecificInstrument, pRspInfo, nRequestID,
                               bIsLast):
    ...
    def __OnRspSubForQuoteRsp(self, pSpecificInstrument, pRspInfo, nRequestID,
                              bIsLast):
    ...
    def __OnRspUnSubForQuoteRsp(self, pSpecificInstrument, pRspInfo,
                                nRequestID, bIsLast):
    ...
    def __OnRtnDepthMarketData(self, pDepthMarketData):
        self.OnRtnDepthMarketData(
            POINTER(CThostFtdcDepthMarketDataField).from_param(
                pDepthMarketData).contents.clone())

    def __OnRtnForQuoteRsp(self, pForQuoteRsp):
        self.OnRtnForQuoteRsp(
            POINTER(CThostFtdcForQuoteRspField).from_param(pForQuoteRsp)
            .contents.clone())
    ...
    def RegisterFront(self, pszFrontAddress):
        self.h.RegisterFront(self.api, bytes(
            pszFrontAddress, encoding='ascii'))

    def RegisterNameServer(self, pszNsAddress):
        self.h.RegisterNameServer(self.api,
                                  bytes(pszNsAddress, encoding='ascii'))
    ...
    def RegisterFensUserInfo(self, BrokerID='', UserID='', LoginMode=''):
        ...
        struc.LoginMode = list(LoginModeType)[
            0].value if LoginMode == '' else LoginMode.value
    ...
    def SubscribeMarketData(self, pInstrumentID):
        ...
        self.h.SubscribeMarketData(
            self.api, (c_char_p * 1)(bytes(pInstrumentID, encoding='ascii')),
            1)

    def UnSubscribeMarketData(self, pInstrumentID):
        self.h.UnSubscribeMarketData.argtypes = [
            c_void_p, c_char_p * 1, c_int32
        ]
        self.h.UnSubscribeMarketData.restype = c_void_p
        self.h.UnSubscribeMarketData(
            self.api, (c_char_p * 1)(bytes(pInstrumentID, encoding='ascii')),
            1)

    def SubscribeForQuoteRsp(self, pInstrumentID):
        self.h.SubscribeForQuoteRsp.argtypes = [
            c_void_p, c_char_p * 1, c_int32
        ]
        self.h.SubscribeForQuoteRsp.restype = c_void_p
        self.h.SubscribeForQuoteRsp(
            self.api, (c_char_p * 1)(bytes(pInstrumentID, encoding='ascii')),
            1)

    def UnSubscribeForQuoteRsp(self, pInstrumentID):
        self.h.UnSubscribeForQuoteRsp.argtypes = [
            c_void_p, c_char_p * 1, c_int32
        ]
        self.h.UnSubscribeForQuoteRsp.restype = c_void_p
        self.h.UnSubscribeForQuoteRsp(
            self.api, (c_char_p * 1)(bytes(pInstrumentID, encoding='ascii')),
            1)
    ...
    def ReqUserLogin(self,
        ...
        struc.InterfaceProductInfo = bytes(
            InterfaceProductInfo, encoding='ascii')
